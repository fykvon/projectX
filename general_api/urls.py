...
urlpatterns = [
    ...
    path('update/', UpdatePlayerView.as_view(), name='update_player'),
    path('delete/', DeletePlayerView.as_view(), name='delete_player'),
    path('detail/', DetailPlayerView.as_view(), name='detail_player'),
